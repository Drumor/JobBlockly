...
Maze.SKIN = {
    ...
    wall: visuals_directory_path + json.visuals.wall,
...
if(json.visuals.obstacleSound.length == 1){
    Maze.SKIN.obstacleSound = [visuals_directory_path+json.visuals.obstacleSound[0]]
}else{
    Maze.SKIN.obstacleSound = []
}
if(json.visuals.winSound.length == 2){
    Maze.SKIN.winSound = [visuals_directory_path+json.visuals.winSound[0]]
}else{
    Maze.SKIN.winSound = []
}
if(json.visuals.crashSound.length == 2){
    Maze.SKIN.crashSound = [visuals_directory_path+json.visuals.crashSound[0]]
}else{
    Maze.SKIN.crashSound = []
}
